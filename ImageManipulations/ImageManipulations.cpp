...
// ImageManipulations.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CImageManipulationsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CImageManipulationsApp

CImageManipulationsApp::CImageManipulationsApp()
{
...
// Единственный объект CImageManipulationsApp

CImageManipulationsApp theApp;


// Инициализация CImageManipulationsApp

BOOL CImageManipulationsApp::InitInstance()
{
